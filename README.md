...
Осилив реакт вы осилите любой другой фреймворк. Это промышленный стандарт, на котором основывается подавляющая часть текущих "хайповых" библиотек, которые помрут через полгода-год (о том же преакте и инферно никто сейчас уже и не говорит, а сколько шума было). Осилив ангулар (второй) вы без труда найдете работу. Вью - худший выбор для первого высокоуровневого инструмента.
