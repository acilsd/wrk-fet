...
## Интро
 ...
 Этот FAQ посвящен вкату во фронтенд-разработку — создание веб-приложений на HTML, CSS и JavaScript. Данное вступление было составлено со слов уже опытных скриптовоенов для неуверенных в себе инфантилов. Прежде, чем задать очередной глупый вопрос — прочитай.
...
Если нужна типизация — [FLOW](https://flow.org/en/docs/getting-started/). Альтернатива — TypeScript.
