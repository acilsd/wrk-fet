...
На стороне ангулара же то, что в нем есть все. Даже черезчур все - и это минус. Чтобы написать какой-нибудь тудулист на А2 вам придется забацать раза в два больше кода, чем на реакте с редаксом: и это при том, что комбинейшен реакт+редакс сами по себе требуют кучу бойлерплейта. Зато на А2 куча энтерпрайза, плюс гугл перешли на семвер и наверняка пойдут в сторону упрощения своего ожиревшего детища.

Вью - неплохая штука для тех, кто:
*  Не знает JS и не хочет его знать, а пилить моднявые интерфейсы ему хочется;
*  Знает все и просто хочет попилить приложухи, не создавая по 10 экшн крийэторов на каждый инпут из-за одностороннего датафлоу и иммутабельности
