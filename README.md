...
- CSS:
  ...
  - Основы сетки: блочная модель, флоаты, инлайн-блоки, флекс
  - Свойства position
...
Обновляемый [роадмап frontend-разработчика](https://roadmap.sh/frontend). Не стоит пугаться большого разнообразия – то, что отмечено фиолетовым, это основное.
...
Список из годных, просмотренных очень многими анонами и ютуб-каналов и курсов:
...
- Канал [freecodecamp](https://www.youtube.com/c/Freecodecamp/videos) – все тот же фрикодкемп, только на youtube.
...
TL;DR: В 2020 TypeScript стал стандартом, большинство новых проектов стартуют на нем. Все остальное (кроме кофе) можно потрогать на досуге, опять же - не прогадаете. Кофе не нужно, пейте чай. Шутка. Нет, правда, кофескрипт не нужен.
